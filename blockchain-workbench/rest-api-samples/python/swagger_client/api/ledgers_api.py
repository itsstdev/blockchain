...
class LedgersApi(object):
    ...
    def ledgers_get(self, **kwargs):    # noqa: E501
        ...
        >>> thread = api.ledgers_get(async=True)
        >>> result = thread.get()
    ...
    def ledgers_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.ledgers_get_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='LedgerList',  # noqa: E501
